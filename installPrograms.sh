...
sudo dnf install -y firefox steam code docker-ce docker-ce-cli containerd.io docker-buildx-plugin docker-compose-plugin qbittorrent lutris brave-browser unityhub
